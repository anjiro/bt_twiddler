...
unsigned long t2 = 0;    //Last time the battery level was printed
...
unsigned int chord = 0;  //Keep track of keys pressed
...
/* 
	...
	key, print its value. If more than one key was pressed:
		...
		- BUG: Press A, B, C, then release C. Print value. Then release B.
			Nothing should happen, but it will probably print again.
*/
